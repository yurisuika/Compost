...
public class Compost implements ModInitializer {
    ...
    public static void registerLootItemConditionTypes() {
        Registry.register(BuiltInRegistries.LOOT_CONDITION_TYPE, Identifier.fromNamespaceAndPath("compost", "match_compostable"), CompostLootItemConditions.MATCH_COMPOSTABLE);
    }

    public static void registerBlockEntityTypes() {
        Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, Identifier.fromNamespaceAndPath("compost", "composter"), CompostBlockEntityType.COMPOSTER);
    }
