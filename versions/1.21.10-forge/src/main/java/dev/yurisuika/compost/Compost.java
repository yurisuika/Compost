...
public class Compost {
    ...
    public static class ModEvents {
        ...
        public static void registerBlockEntityTypes(RegisterEvent event) {
            event.register(ForgeRegistries.Keys.BLOCK_ENTITY_TYPES, helper -> helper.register(ResourceLocation.fromNamespaceAndPath(MOD_ID, "composter"), CompostBlockEntityType.COMPOSTER));
        }
