...
public class Compost implements ModInitializer {
    ...
    public static void registerLootItemConditionTypes() {
        Registry.register(BuiltInRegistries.LOOT_CONDITION_TYPE, ResourceLocation.fromNamespaceAndPath("compost", "match_compostable"), CompostLootItemConditions.MATCH_COMPOSTABLE);
    }
