...
public class Compost {
    ...
    public static class ModEvents {
        ...
        public static void registerLootItemConditionTypes(RegisterEvent event) {
            event.register(BuiltInRegistries.LOOT_CONDITION_TYPE.key(), helper -> helper.register(Identifier.fromNamespaceAndPath(MOD_ID, "match_compostable"), CompostLootItemConditions.MATCH_COMPOSTABLE));
        }
