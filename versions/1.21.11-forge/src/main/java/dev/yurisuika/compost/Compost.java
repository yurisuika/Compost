...
public class Compost {
    ...
    public static class ModEvents {
        ...
        public static void registerBlockEntityTypes(RegisterEvent event) {
            event.register(ForgeRegistries.Keys.BLOCK_ENTITY_TYPES, helper -> helper.register(Identifier.fromNamespaceAndPath("compost", "composter"), CompostBlockEntityType.COMPOSTER));
        }
