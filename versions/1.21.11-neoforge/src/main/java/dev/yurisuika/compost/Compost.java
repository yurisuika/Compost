...
public class Compost {
    ...
    public static class ModEvents {
        ...
        public static void registerLootContextKeySets(RegisterEvent event) {
            LootContextParamSets.REGISTRY.put(Identifier.fromNamespaceAndPath("compost", "composter"), CompostLootContextParamSets.COMPOSTER);
        }

        @SubscribeEvent
        public static void registerLootItemConditionTypes(RegisterEvent event) {
            event.register(BuiltInRegistries.LOOT_CONDITION_TYPE.key(), helper -> helper.register(Identifier.fromNamespaceAndPath("compost", "match_compostable"), CompostLootItemConditions.MATCH_COMPOSTABLE));
        }

        @SubscribeEvent
        public static void registerBlockEntityTypes(RegisterEvent event) {
            event.register(BuiltInRegistries.BLOCK_ENTITY_TYPE.key(), helper -> helper.register(Identifier.fromNamespaceAndPath("compost", "composter"), CompostBlockEntityType.COMPOSTER));
        }
