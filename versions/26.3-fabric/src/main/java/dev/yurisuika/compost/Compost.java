...
public class Compost implements ModInitializer {
    ...
    public static void registerLootContextKeySets() {
        Registry.register(BuiltInRegistries.CONTEXT_KEY_SET, Identifier.fromNamespaceAndPath(MOD_ID, "composter"), CompostLootContextParamSets.COMPOSTER);
    }

    public static void registerLootItemConditionTypes() {
        Registry.register(BuiltInRegistries.LOOT_CONDITION_TYPE, Identifier.fromNamespaceAndPath(MOD_ID, "match_compostable"), MatchCompostable.CODEC);
    }
